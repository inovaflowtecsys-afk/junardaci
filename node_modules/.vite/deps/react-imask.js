...
var MASK_PROPS = {
	mask: import_prop_types.default.oneOfType([
		...
		import_prop_types.default.instanceOf(RegExp),
		import_prop_types.default.oneOf([
			Date,
			Number,
			IMask.Masked
		]),
		import_prop_types.default.instanceOf(IMask.Masked)
	]),
...
function IMaskMixin(ComposedComponent) {
	var _Class;
	const MaskedComponent = (_Class = class MaskedComponent extends import_react.Component {
		constructor(props) {
			super(props);
		...
		_inputRef(el) {
			this.element = el;
			if (this.props.inputRef) if (Object.prototype.hasOwnProperty.call(this.props.inputRef, "current")) this.props.inputRef.current = el;
			else this.props.inputRef(el);
		}
		initMask(maskOptions) {
			if (maskOptions === void 0) maskOptions = this._extractMaskOptionsFromProps(this.props);
		...
		render() {
			return import_react.createElement(ComposedComponent, {
				...this._extractNonMaskProps(this.props),
				inputRef: this._inputRef
			});
		}
	}, _Class.displayName = void 0, _Class.propTypes = void 0, _Class);
	MaskedComponent.displayName = "IMask(" + (ComposedComponent.displayName || ComposedComponent.name || "Component") + ")";
	MaskedComponent.propTypes = MASK_PROPS;
	return import_react.forwardRef((props, ref) => import_react.createElement(MaskedComponent, {
		...props,
		ref
	}));
}
...
var IMaskInputFn = (props, ref) => import_react.createElement(IMaskInputClass, {
	...props,
	ref
});
var IMaskInput = import_react.forwardRef(IMaskInputFn);
//#endregion
//#region node_modules/react-imask/esm/hook.js
function useIMask(opts, _temp) {
	let { onAccept, onComplete, ref = (0, import_react.useRef)(null), defaultValue, defaultUnmaskedValue, defaultTypedValue } = _temp === void 0 ? {} : _temp;
	const maskRef = (0, import_react.useRef)(null);
	const [lastAcceptState, setLastAcceptState] = (0, import_react.useState)({});
	const [value, setValue] = (0, import_react.useState)("");
	const [unmaskedValue, setUnmaskedValue] = (0, import_react.useState)("");
	const [typedValue, setTypedValue] = (0, import_react.useState)();
	const _destroyMask = (0, import_react.useCallback)(() => {
		var _maskRef$current;
		(_maskRef$current = maskRef.current) == null || _maskRef$current.destroy();
		maskRef.current = null;
	}, []);
	const storeLastAcceptedValues = (0, import_react.useCallback)(() => {
	...
	const _onAccept = (0, import_react.useCallback)((event) => {
		const m = maskRef.current;
		if (!m) return;
		storeLastAcceptedValues();
		onAccept?.(m.value, m, event);
	}, [onAccept]);
	const _onComplete = (0, import_react.useCallback)((event) => maskRef.current && (onComplete == null ? void 0 : onComplete(maskRef.current.value, maskRef.current, event)), [onComplete]);
	...
	(0, import_react.useEffect)(() => _destroyMask, [_destroyMask]);
	return {
		ref,
		maskRef,
		value,
...
//#endregion
export { IMask, IMaskInput, IMaskMixin, useIMask };
